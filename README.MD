This is a system to automatically generate certificates for the Local Hack Day 2015 when given a CSV with names of the participiants from the MLH Organizer (organizer.mlh.io)
